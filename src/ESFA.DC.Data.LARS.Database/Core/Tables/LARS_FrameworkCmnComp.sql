CREATE TABLE [Core].[LARS_FrameworkCmnComp] (
	...
	CONSTRAINT [FK_Core_LARS_FrameworkCmnComp_CoreFramework] FOREIGN KEY ([FworkCode],[ProgType],[PwayCode]) REFERENCES [Core].[LARS_Framework] ([FworkCode],[ProgType],[PwayCode]) ON DELETE CASCADE
);
