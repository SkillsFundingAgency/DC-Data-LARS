CREATE TABLE [Core].[LARS_LearningDelivery] (
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_Core_LARSLearningDelivery_LearnAimRef_Unique]
    ON [Core].[LARS_LearningDelivery]([LearnAimRef] ASC);
