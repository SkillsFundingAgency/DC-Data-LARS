CREATE TABLE [Staging].[LARS_Section96] (
    ...
    CONSTRAINT [PK_Staging_LARS_Section96] PRIMARY KEY CLUSTERED ([LearnAimRef] ASC, [EffectiveFrom] ASC) WITH (FILLFACTOR = 90)
);


GO
GRANT ALTER ON OBJECT::Staging.LARS_Section96 TO [Lars_RW_User];
