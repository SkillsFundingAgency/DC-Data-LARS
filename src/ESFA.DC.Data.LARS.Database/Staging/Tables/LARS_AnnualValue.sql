CREATE TABLE [Staging].[LARS_AnnualValue] (
    ...
    CONSTRAINT [PK_Staging_LARS_AnnualValue] PRIMARY KEY CLUSTERED ([LearnAimRef] ASC, [EffectiveFrom] ASC) WITH (FILLFACTOR = 90)
);

GO
GRANT ALTER ON OBJECT::Staging.LARS_AnnualValue TO [Lars_RW_User];